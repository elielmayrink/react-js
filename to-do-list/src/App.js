  ...
  return (
    <div className="App">
      ...
      <div className="container-todo">
        <ul>
          {list.map((i) => (
            <li className={i.done ? "isdone" : ""} key={i.id}>
              ...
              {i.descrInput && (
                <form
                  onSubmit={(e) =>
                    handleDescription(e, setDescription, () =>
                      addDescription(
                        i.id,
                        list,
                        setList,
              ...
              {i.description === "" && (
                <button
                  onClick={() =>
                    showInputToDescription(i.id, list, setList, description)
                  }
                >
                  +
                </button>
      ...
      <div>
        ...
        <ul style={{ listStyle: "decimal" }}>
          {todoDone &&
            doneList.map((i) => (
              <li key={i.id}>
                <span className={i.done ? "todoDone" : ""}>{i.text}</span>
              </li>
            ))}
        </ul>
      </div>
